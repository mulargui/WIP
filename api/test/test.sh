...
date +"%T.%3N" ; echo zipcode=98052&lastname1=anderson&gender=f&specialty=Nurse
curl -L -H 'Content-Type: application/json' $URL?zipcode=98052&lastname1=anderson&gender=f&specialty=Nurse ; echo
date +"%T.%3N" ; echo zipcode=98052&distance=10&lastname1=anderson&lastname2=brock&lastname3=tang-xue&gender=f&specialty=General%20Practice ; echo
